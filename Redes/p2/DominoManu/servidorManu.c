...
int main ( ) {
	...
	char *contra;			// Contraseña
	char linea[100];	// Auxiliar
	char linea2[100];	// Auxiliar
	char cad[200];		// Auxiliar
	...
	char *extremo;	  // Extremo donde colocar la ficha
	...
	flagFin = 0;			// Flag para el fin de partida
...
////////////////////////////////////////////////////////////////////////////////
                  ...
                  // printf("%s\n", contra);
									...
									send(cliente[j].socket, "\t+Ok. Registrado.\n\n", 250, 0);
								}
...
////////////////////////////////////////////////////////////////////////////////
            ...
            // Usuario en el servidor
                ...
                cli[esperando].mesa = nMesa;
                  ...
                  for(x = 0; x < 2; x++)
									{
										send(cli[x].socket,"FICHAS: ", 250, 0);
										sleep(1);
										verFichas(cli[x]);
										sleep(1);
...
printf("valor de j %d\n",j );
for(int k=0; k<n; k++){
	printf("(yo)nivel del cliente %d: %d, %d\n",k,cliente[k].nivel,cliente[k].mesa );
								}
							}
...
printf("HOLAAAAAAAAAAA-> Extremo correcto: %d\n", flag);
											...
											if(flag == 1)
											{
												...
												if(ponerFicha(&party[i], f))
												{
													...
													//cad2 = verFichas(cli[(pep + 1) % 2]);
													//send(party[i].turno, cad2, 250, 0);
												}
												else
												{
