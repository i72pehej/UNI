            ...
            <div class="contenedor">
                <div class="cards">
                    ...
                    <div class="card">
						...
						<input type="submit" id="editar" value="editarPerfil" name="Editar Perfil" class="boton" onclick="habilitarCampo();">
							
                        <form method="get" action="CV.html">
                            <input type="submit" id="crearCV" value="crearCV"  name="crearCV" class="boton">
                        </form>		
                    </div>
