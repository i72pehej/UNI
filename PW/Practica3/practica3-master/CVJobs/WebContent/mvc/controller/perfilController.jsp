...
<body onload="getParams()">
	...
	<%
		Hashtable<String,String> listado ;
		if(request.getParameter("correo")!=null){
			System.out.println("ENTRAAAAAAAAAAAAAAA");
			String correo = request.getParameter("correo");
			System.out.println("ENTRAAAAAAAAAAAAAAA "+correo);
			usuario.setCorreoPersona(request.getParameter("correo"));
			listado = daoPerfil.listarPersona(usuario.getCorreoPersona());
		}else{
			listado = daoPerfil.listarPersona(usuario.getCorreo());
		}
		if(usuario.getCorreo()!=null){
			...
			ArrayList<es.uco.pw.display.javabean.ComentarioBean> listar ;
			if(request.getParameter("correo")!=null){
				String correo = request.getParameter("correo");
				usuario.setCorreoPersona(request.getParameter("correo"));
				listar = daoPerfil.listarComentariosUsuario(usuario.getCorreoPersona());
			}else{
				listar = daoPerfil.listarComentariosUsuario(usuario.getCorreo());
			}
